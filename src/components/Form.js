...
const Form = () => {
    return (
        <form className="mt-0 pb-12 pt-12 md:items-center mx-4 md:max-w-md md:">
            <div>
                <input className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Your Name"/>
            </div>
            ...
            <button className="bg-sky-500 text-white rounded-lg p-2 my-4 hover:bg-sky-700">Calculate</button>
        </form>
    )
}
